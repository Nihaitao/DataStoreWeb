...
namespace Common
{
    public class ProfileManager
    {
      ...
      //  public const string AuthServiceUrl = "http://webapi.chutoukj.com/";   //正式环境
        //public const string AuthServiceUrl = "http://localhost:30400/";   //测试环境
        static ProfileManager()
        {
            //正式
            //routeDictionary.Add("/service/public", "http://webpublic.chutoukj.com/");  //公用方法正式
            //routeDictionary.Add("/service/datastore", "http://webdatastore.chutoukj.com/"); //资源正式
            //routeDictionary.Add("/service/pay", "http://app.api.chutoukj.com/"); //支付正式
            //routeDictionary.Add("/service/finance", "http://webfinance.chutoukj.com/"); //财务正式

            //路由字典，请求路径
            routeDictionary.Add("/service/me/", "http://localhost:30400/"); //CRM测试
            routeDictionary.Add("/service/crm", "http://webcrmceshi.chutoukj.com/"); //CRM测试
            routeDictionary.Add("/service/public", "http://webpubliccs.chutoukj.com/");  //公用方法测试
            routeDictionary.Add("/service/finance", "http://webfinanceceshi.chutoukj.com/");  //财务测试
            routeDictionary.Add("/service/datastore", "http://webdatastoreceshi.chutoukj.com/"); //资源测试
            //routeDictionary.Add("/service/datastore", "http://localhost:63795/"); //资源测试
            routeDictionary.Add("/service/edu", "http://edu.api.chutoukj.com/");  //教务测试
            routeDictionary.Add("/service/pay", "http://apptest.api.chutoukj.com/"); //支付测试
        ...
        public static ByteRequest GetByteRequest(Uri requestUri)
        {
            var resourceUrl = string.Empty;
            var clientProfile = GetClientProfile(requestUri, out resourceUrl);
            return new ByteRequest(resourceUrl, clientProfile);
        }
    }
