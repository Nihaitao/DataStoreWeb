/*
 * polyv-jquery-client
 * https://github.com/easefun/polyv-jquery-client
 *
 * Copyright (c) 2013
 * http://www.polyv.net/
 *
...
layui.define(["jquery"],
    function(exports) {
        ...
        var $ = layui.$;
        var MOD_NAME = 'jquerypolyv';
        // The Public API
        var polyv = window.polyv = {
            ...
            fingerprint: function(file, option) {
                return 'polyv-' + option.userid + option.cataid + option.title + '-' + file.type + '-' + file.size;
            }
        };
        ...
        function ResumableUpload(file, options) {
            ...
            // The url of the uploaded file, assigned by the polyv upload endpoint
            this.fileUrl = null;
        ...
        // Creates a file resource at the configured polyv endpoint and gets the url for it.
        ...
        ResumableUpload.prototype._post = function() {
            ...
            var options = {
                ...
                data: {
                    ...
                    cataid: self.options.cataid,
                    luping: self.options.luping,
            ...
            $.ajax(options)
                .fail(function(jqXHR, textStatus, errorThrown) {
                    ...
                    self._emitFail(textStatus);
                })
                .done(function(data, textStatus, jqXHR) {
                    var location = jqXHR.getResponseHeader('Location');;
                    if (!location) {
                        return self._emitFail(textStatus);
                    }
        ...
        ResumableUpload.prototype._head = function() {
            ...
            $.ajax(options)
                .fail(function(jqXHR, textStatus, errorThrown) {
                    ...
                    localStorage.removeItem(polyv.fingerprint(self.file, self.options));
                    self._post();
                })
                .done(function(data, textStatus, jqXHR) {
        ...
        // Uploads the file data to polyv resource url created by _start()
        ResumableUpload.prototype._uploadFile = function(range_from, range_to) {
            var self = this;

            if (typeof self.options.urlCallback == 'function') {
                self.options.urlCallback.call(this.fileUrl, self);
            }
            ...
            var options = {
                ...
                headers: {
                    ...
                    'writeToken': self.options.writeToken
                }
            };
        ...
        ResumableUpload.prototype.getResponse = function() {
            if (this._jqXHR) {
        ...
        ResumableUpload.prototype._emitDone = function(res) {
            this._deferred.resolveWith(this, [this.fileUrl, this.file, res]);
        };
        ...
        ResumableUpload.prototype._urlCache = function(url) {
            ...
            if (fingerPrint === undefined) {
                fingerPrint = polyv.fingerprint(this.file, this.options);
            }
        ...
        exports(MOD_NAME, ResumableUpload);
    });